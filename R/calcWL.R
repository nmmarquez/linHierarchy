...
#' 
#' Find the 'w' or 'l' paramter of the David's score algorithim for the
...
#' corresponding parmeter.
#' @description Calculates the w or l paramter of the Davids score algorithim.
...
#' interData object. L is the sum of all (1 - Pij). Ties are disregarded in 
...
#' @return Either w a sum of individuals Pij percentages or L a 
#' @examples 
...
#' calcWL (id1$players [1], id1, 'l')
#' @export

calcWL <- function (player, intData, param = 'w'){
